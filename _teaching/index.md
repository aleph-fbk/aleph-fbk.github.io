...
{% assign courses_BSc = site.teaching | where_exp: "course", "course.level contains 'BSc'" | sort: "name" %}
{% assign courses_MSc = site.teaching | where_exp: "course", "course.level contains 'MSc'" | sort: "name" %}
...
{% assign courses_PhD = site.teaching | where_exp: "course", "course.level contains 'PhD'" | sort: "name" %}
...
{% assign courses_highSchools = site.teaching | where_exp: "course", "course.level contains 'High School'" | sort: "name" %}
...
{% assign courses_other = site.teaching | where_exp: "course", "course.level == nil" | sort: "name" %}
